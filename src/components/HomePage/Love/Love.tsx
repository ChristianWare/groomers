...
import Img2 from "../../../../public/images/catLove.jpg";
          ...
          <div className={styles.parent}>
            <div className={styles.bottom}>
              <div className={styles.top}>
                <SectionIntro title='Care for cats' />
                <h2 className={styles.heading}>Cats need love too!</h2>
                <p className={styles.copy}>
                  We understand that dogs are more than just pets; they are
                  family members who deserve the best care and attention. Our
                  grooming services are designed to keep your furry friend
                  looking and feeling their best, while also promoting their
