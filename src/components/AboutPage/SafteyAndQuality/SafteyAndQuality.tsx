...
import Img1 from "../../../../public/images/servicesIntroiii.png";
        ...
        <div className={styles.content}>
          ...
          <div className={styles.right}>
            <h2 className={styles.heading}>
              We have a proven record of <br />{" "}
              <span className={styles.span}>safety and quality</span>
            </h2>
